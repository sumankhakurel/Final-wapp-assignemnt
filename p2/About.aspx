<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="About.aspx.cs" Inherits="Assignment.assignment.About" %>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-7">
                    <div class="text-left mb-4">
                        <h5 class="text-primary text-uppercase mb-3" style="lighting-color: 5px;">About Us</h5>
                        <h1>Innovative Way To Learn</h1>
                    </div>
                    <p>It can provide learners with customized learning paths based on their interests, skill levels, and learning styles. This way, learners can focus on the areas they need to improve and progress at their own pace. It uses interactive simulations and gamification techniques to create engaging learning experiences. For example, learners can use simulations to practice real-world scenarios, or gamification techniques like points, badges, and leaderboards to motivate learners and track their progress. With the widespread use of mobile devices, eLearning sites can provide learners with mobile-optimized content and apps that allow them to learn on the go. This makes learning more accessible and convenient for busy learners.</p>
